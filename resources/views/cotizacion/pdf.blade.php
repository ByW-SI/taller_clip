	      ...
	      <div class="row">
              ...
              <th scope="row">Fecha:</th>
	      		...
	      		<tr>
	      			...
	      			<td>JESUS FLORES No. 105, COL. OBSERVATORIO</td>
	      			<th scope="row">Moneda:</th>			
	      			<td>Moneda Nacional (MXN)</td>
	      		</tr>
	      		<tr>
	      			<th scope="row">Telefono:<br>email:</th>
	      			<td style="color: rgb(6,130,238);">55166077 Y 55166078<br>xaviergaona@yahoo.com</td>
	      			<th scope="row">Vigencia:</th>			
	      			<td><b>2 Meses</b></td>
	      		</tr>	
	      		<tr>
	      			<th scope="row">Numero de cotizacion</th>
	      			<td>{{$cotizacion->nocotizacion}}</td>
	      			<th scope="row">Cliente:</th>
	      			<td>{{($cotizacion->cliente->tipopersona == "Fisica" ? $cotizacion->cliente->nombre." ".$cotizacion->cliente->apellidopaterno." ".$cotizacion->cliente->apellidomaterno : $cotizacion->cliente->razonsocial )}}
	      		</tr>      		
	      	</table>
          <div class="row" style="text-align: center;">
            <img src="{{public_path('img/header-pdf.png')}}" alt="" width="80%" height="80%">
          </div>
	      </div>
	    </div>
	    <div class="card-body">
