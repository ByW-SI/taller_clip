                ...
                <div class="panel-body">
                    <div class="row">
                        {{-- <div class="form-group col-sm-4"> --}}
                            ...
                            <input type="hidden" name="name" class="form-control" value="{{ $usuario->name }}" required="" readonly>
                        {{-- </div> --}}
                        <div class="form-group col-sm-4">
                            <label class="control-label">*Correo/Usuario:</label>
                            <input type="text" name="email" class="form-control" value="{{ $usuario->email }}" required="" readonly>
                        </div>
                        <div class="form-group col-sm-4">
                            <label class="control-label">*Nombre:</label>
                            <input type="text" name="nombre" class="form-control" value="{{ $usuario->nombre }}" required="" readonly>
                        </div>
                        <div class="form-group col-sm-4">
                            <label class="control-label">*Apellido Paterno:</label>
                            <input type="text" name="appaterno" class="form-control" value="{{ $usuario->appaterno }}" required="" readonly>
                        </div>
                        <div class="form-group col-sm-4">
